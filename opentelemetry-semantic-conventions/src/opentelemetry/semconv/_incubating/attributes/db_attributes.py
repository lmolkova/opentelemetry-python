...
class DbCosmosdbOperationTypeValues(Enum):
    ...
    """execute."""
    EXECUTE_JAVASCRIPT: Final = "execute_javascript"
    """execute_javascript."""
    INVALID: Final = "invalid"
    """invalid."""
    HEAD: Final = "head"
    """head."""
    HEAD_FEED: Final = "head_feed"
    """head_feed."""
    PATCH: Final = "patch"
    """patch."""
    QUERY: Final = "query"
...
class DbSystemValues(Enum):
    ...
    INTERSYSTEMS_CACHE: Final = "intersystems_cache"
    """InterSystems Caché."""
