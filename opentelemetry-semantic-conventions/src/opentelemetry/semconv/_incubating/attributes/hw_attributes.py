...
class HwTypeValues(Enum):
    ...
    CPU: Final = "cpu"
    """CPU."""
    DISK_CONTROLLER: Final = "disk_controller"
    """Disk controller."""
    ...
    GPU: Final = "gpu"
    """GPU."""
    LOGICAL_DISK: Final = "logical_disk"
    """Logical disk."""
    MEMORY: Final = "memory"
    """Memory."""
    NETWORK: Final = "network"
    """Network."""
    PHYSICAL_DISK: Final = "physical_disk"
    """Physical disk."""
    POWER_SUPPLY: Final = "power_supply"
    """Power supply."""
    TAPE_DRIVE: Final = "tape_drive"
    """Tape drive."""
