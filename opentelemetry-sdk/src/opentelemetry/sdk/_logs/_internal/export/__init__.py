...
class SimpleLogRecordProcessor(LogRecordProcessor):
    ...
    received logs in the export-friendly LogRecord to the
    ...
    def on_emit(self, log_record: APILogRecord):
        if self._shutdown:
...
class BatchLogRecordProcessor(LogRecordProcessor):
    ...
    def on_emit(self, log_record: APILogRecord) -> None:
        ...
        self._queue.appendleft(log_record)
